...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/electrique.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh material-color={props.customColors.face} geometry={nodes.Plano.geometry} material={materials.Corpo} position={[-3.17, 0, 1.88]} />
      ...
      <mesh material-color={props.customColors.body} geometry={nodes.Plano001.geometry} material={materials['Material.003']} position={[-0.28, 0, 1.85]} />
      ...
      <mesh material-color={props.customColors.circulos} geometry={nodes.Círculo003.geometry} material={materials['Botões de Volume']} position={[-3.59, 0.68, 2.58]} rotation={[-0.04, 0, 0.1]} scale={0.11} />
    </group>
  )
}
